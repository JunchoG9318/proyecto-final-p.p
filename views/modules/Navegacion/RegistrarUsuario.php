    ...
    <div class="row m-5 align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-center">
            ...
            <div class="card" style="width: 20rem;">
                ...
                <img src="<?php echo BASE_URL; ?>imagenes/funICBF.jpg" class="card-img-top" alt="Funcionario ICBF"
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <a href="<?php echo BASE_URL; ?>views/modules/login/NuevoUsuario.php" class="btn btn-primary">
                            Registrarse
                        </a>
                    </div>
    ...
    <div class="row m-5 align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-center">
            ...
            <div class="card" style="width: 20rem;">
                ...
                <img src="<?php echo BASE_URL; ?>imagenes/TSFUN.jpg" class="card-img-top" alt="Funcionario Fundación"
    ...
    <div class="row m-5 align-items-center">
        ...
        <div class="col-md-6 d-flex justify-content-center">
            ...
            <div class="card" style="width: 20rem;">
                ...
                <img src="<?php echo BASE_URL; ?>imagenes/FAMILIA.jpg" class="card-img-top" alt="Registro Familiar"
                    style="height: 200px; object-fit: cover;" />
                ...
                <div class="card-body">
                    ...
                    <div class="text-center">
                        <a href="<?php echo BASE_URL; ?>views\modules\Familias\registro_familiar.php"
